...
public class FindTokensTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"find-keyword", "find-non-operators", "invalid-keyword", "invalid-keyword-has-operator"})
    public void testFindKeyWords(String directory) throws FileNotFoundException {
        ...
        List<Token> tokens = TokenSerializer.deserializeTokens(srcFile).stream()
