...
public class TypeAnalyzerTest {
  ...
  public void testASTIsLeaf() {
    ...
    context.addVariable(new ConcreteVariable("x", new VariableType(KeyWord.STRING.getName(), KeyWord.STRING.getOrdinal())));
    context.addVariable(new ConcreteVariable("y", new VariableType(KeyWord.NUMBER.getName(), KeyWord.NUMBER.getOrdinal())));
