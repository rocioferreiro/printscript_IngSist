...
public class lalalallalalala {
  ...
  public void testRemoveEntersHappyPath() {
    ...
    expectedResult.add(
        new Line(" el reacciono como si hubiese dicho \"Decime como estas o te mato.\"", 2));
  ...
  public void testRemoveEntersWithEntersInString() {
    ...
    expectedResult.add(
        new Line(" el reacciono como si hubiese dicho \"Decime como \n estas o te mato.\"", 2));
  ...
  public void testRemoveEntersWithEntersInBeginning() {
    ...
    expectedResult.add(
        new Line(" el reacciono como si hubiese dicho \"Decime como estas o te mato.\"", 4));
